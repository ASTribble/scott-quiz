  ...
  makeAnswerBlock() {
    ...
    const answersString = this.answers.map((answer) => {
      ...
      <div class='choice-container'>
        <input type="radio" name="choice" value=${this.answers.indexOf(answer)} class="choice" id="choice-${this.answers.indexOf(answer)}" required>
...
function renderStartView() {
  ...
  return `
    <header class="title">
        <h1>Welcome to My Not-So Basic Quiz</h1>
    </header>
